...
| SLOT-ID          | Section   | Kind  | Aspect / Duration | Tone notes                                                                                  | Codec ladder (video) | Current file | Final file (status) | Notes                                                                                   |
| ---------------- | --------- | ----- | ----------------- | ------------------------------------------------------------------------------------------- | -------------------- | ------------ | ------------------- | --------------------------------------------------------------------------------------- |
| **LANDMARK-01**  | Landmark  | image | 9:16 portrait     | Tower silhouette against sky. Dawn or dusk grade. Architectural, not advertorial.           | —                    | (pending)    | (pending)           | Vertical hero. Camera tilt-up framing.                                                  |
| **LANDMARK-02**  | Landmark  | image | 4:5 portrait      | Facade detail — material, glass, edge. Macro feel.                                          | —                    | (pending)    | (pending)           | Enters from right during horizontal decomposition stage.                                |
| **LANDMARK-03**  | Landmark  | image | 1:1 (optional)    | Glass / media-wall detail. Optional.                                                        | —                    | (pending)    | (pending)           | Decide visually during Unit 8.                                                          |
| **FLOW-MORNING** | Day       | image | 21:9 wide         | 06:12 — first light on the water. Cool-warm gradient.                                       | —                    | (pending)    | (pending)           | First frame in horizontal time film.                                                    |
| **FLOW-SURF**    | Day       | image | 21:9 wide         | 13:40 — surf line, mid-day quiet, no figures or 1–2 silhouettes max.                        | —                    | (pending)    | (pending)           | Second frame.                                                                           |
| **FLOW-WALK**    | Day       | image | 21:9 wide         | 18:27 — walking pace late afternoon, golden hour but restrained.                            | —                    | (pending)    | (pending)           | Third frame.                                                                            |
| **FLOW-LIGHT**   | Day       | image | 21:9 wide         | 21:05 — lights on, deep blue hour. Building presence implied, not centered.                 | —                    | (pending)    | (pending)           | Fourth frame.                                                                           |
| **WINDOW-01**    | Window    | image | 16:9              | Main interior view from the room's perspective. Quiet. View dominant, room incidental.      | —                    | (pending)    | (pending)           | Holds nearly still during pin.                                                          |
| **WINDOW-02**    | Window    | image | 4:3 small         | Floating editorial frame. Detail (cup, sill, fabric, light).                                | —                    | (pending)    | (pending)           | Drifts with subtle Y translation.                                                       |
| **WINDOW-03**    | Window    | image | 4:3 small         | Floating editorial frame, optional second.                                                  | —                    | (pending)    | (pending)           | Decide 1 vs 2 during Unit 10.                                                           |
